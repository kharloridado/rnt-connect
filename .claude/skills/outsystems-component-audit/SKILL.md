...
1. Look for the `outsystems-conventions` memory (recalled automatically; also indexed in `MEMORY.md`). If absent, invoke `outsystems-onboarding` first.
...
- `references/figma-mcp-usage.md` — Pulling audit data straight from Figma via MCP
