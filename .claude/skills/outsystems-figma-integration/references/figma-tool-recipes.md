...
Common task patterns and which Figma tools to use. Always call `ToolSearch` first to load tool schemas before calling.
...
**Tool sequence:**
```
1. ToolSearch("figma design context")
...
**Tool sequence:**
```
1. ToolSearch("figma variable definitions")
...
**Tool sequence:**
```
1. ToolSearch("figma libraries design system")
...
These are general patterns. **Always verify parameter names by reading the schema returned from `ToolSearch`** — they may differ.
