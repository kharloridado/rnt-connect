...
Check memory for:
- the class prefix, from the `outsystems-conventions` memory (for naming consistency)
- the customer and project name, from the `outsystems-project-context` memory (for commit scope)
