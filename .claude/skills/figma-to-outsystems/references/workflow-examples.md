...
1. ✅ Check for the `outsystems-conventions` memory — **MISSING** → invoke `outsystems-onboarding`
2. Onboarding presents 4 questions
3. User answers: `acme-`, ODC, 8pt, OutSystems UI standard
4. Memory stored
5. ✅ Check for the `outsystems-project-context` memory — **MISSING** → invoke `outsystems-project-context`
